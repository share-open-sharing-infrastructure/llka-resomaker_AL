...
interface ReservationInfo {
  ...
  email: string;
  pickup: string;
  /** true when this reservation also registered the person. */
  registered?: boolean;
        ...
        <Card className="mb-6 border-amber-200 bg-amber-50">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-amber-800">
              Deine Daten sind hinterlegt – du musst vor Ort keinen
              Nutzungsantrag mehr ausfüllen. Bring zur ersten Abholung bitte
              einen <strong>Ausweis</strong> mit, damit wir deine Angaben
              einmalig bestätigen können.
            </p>
          </CardContent>
        </Card>
      )}
